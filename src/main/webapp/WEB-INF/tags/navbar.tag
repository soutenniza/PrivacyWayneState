    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="${(pageContext.request.requestURI eq '/WEB-INF/pages/snviewlogin.jsp')||(pageContext.request.requestURI eq '/WEB-INF/pages/snviewhome.jsp')||(pageContext.request.requestURI eq '/WEB-INF/pages/snviewprofile.jsp')||(pageContext.request.requestURI eq '/WEB-INF/pages/snviewpost.jsp') ? 'active' : ''}">
